...
- **Rack Topology** — 랙 추가/삭제, zone/region/nodeName 할당, per-rack config/storage/scheduling 오버라이드
...
- **Config Drift Detection** — spec vs appliedSpec 비교, Pod별 config hash 그룹핑, Force Reconcile 버튼
